      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-2 col-md-6 mb-5 mb-lg-0">
            ...
            <?php foreach ($topFiveTypes as $type): ?>
              <!-- L'URL doit être "absolue" comme pour les CSS etc. -->
              <li><a href="<?= $router->generate('type', ['id' => $type->getId()]); ?>" class="text-muted"><?= $type->getName(); ?></a></li>
              <?php endforeach ?>
